...
def create_default_environment():
    ...
    env.declare_global("inf", inter.F32Value(float("inf")), True, None)
    env.declare_global("nan", inter.F32Value(float("nan")), True, None)
...
# random (RNG) stuff
static u32 RAND_MAX = 2**32 - 1 # 0xFFFFFFFF
